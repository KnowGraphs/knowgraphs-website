...
Since 2005 he coordinates the Semantic Access and Retrieval group, and from 2019 also the Centre for Cultural Informatics of the Information Systems Laboratory of FORTH-ICS. He is the coordinator of the Clarity and Open Data Management Team of the University of Crete and he is member of the Executive Committee ERCIM (the European Research Consortium for Informatics and Mathematics).</div><div class="column is-one-quarter"><img src="/ws23-img/YannisTzitzikas.png" alt="Yannis Tzitzikas photo" style="width: 100%; height: 100%; object-fit: cover; object-position: center center; opacity: 1; transition: opacity 500ms ease 0s;" /></div></div>
...
<div class="columns"><div class="column">_Biography_: TBA</div><div class="column is-one-quarter"><img src="/ws23-img/Roberto.jpg" alt="Roberto Navigli photo" style="width: 100%; height: 100%; object-fit: cover; object-position: center center; opacity: 1; transition: opacity 500ms ease 0s;" /></div></div>
